/*
--Primitive Types--
Integers: u8, i8, u16, i16, u32, i32, u64, i64, u128, i128 (# of bits they take in memory; u can't be negative but i can)
Floats: f32, f64
Boolean (bool)
Characters (char)
Tuples
...
pub fn run() {
    ...
    // char can be any single unicode character; denoted with single quotes
    let a1 = 'a';
    let face = '\u{1F600}';
